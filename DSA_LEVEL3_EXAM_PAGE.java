...
public class DSA_LEVEL3_EXAM_PAGE {
    ...
    private static final String[] questions = {
            ...
            "What is the height of a full binary tree with n nodes?",
            "Which of the following sorting algorithms is not comparison-based?",
            "What is the auxiliary space complexity of merge sort?",
            "Which graph traversal algorithm is similar to preorder traversal of a tree?",
            ...
            "What is the time complexity for finding the shortest path in an unweighted graph using BFS?",
            "Which data structure is used to implement a depth-first search (DFS) algorithm?",
            "In the context of hash tables, what is a 'collision'?",
            "What is the worst-case time complexity of quicksort?",
            "Which data structure supports fast insertion and deletion but slow random access?",
            "What is the purpose of a 'hash function' in a hash table?",
            "What is the minimum number of edges in a connected graph with n vertices?",
            "Which algorithm is used to check for strong connectivity in a directed graph?",
            "What is the key idea behind dynamic programming?",
            "Which of the following problems can be solved using the greedy algorithm?",
            "Which data structure is commonly used to solve the longest common subsequence problem?",
            "What is the advantage of using a doubly linked list over a singly linked list?",
            "What is the time complexity of binary search in a sorted linked list?",
            "What is the time complexity of heap sort in all cases?",
            "Which traversal of a binary tree provides sorted data if the tree is a binary search tree?",
            "What is a sparse matrix?",
            "What is the difference between Prim's and Kruskal's algorithm for finding a minimum spanning tree?",
            "What is a bloom filter used for?",
            "What is the time complexity of accessing an element in a hash map?",
            "What is the number of possible binary search trees that can be formed with n distinct keys?"
    };
    ...
    private static final String[][] options = {
            ...
            {"AVL Tree", "Red-Black Tree", "Binary Heap", "B-tree"},
            {"log n", "n-1", "n/2", "log(n+1)"},
            {"Quick Sort", "Merge Sort", "Heap Sort", "Radix Sort"},
            {"O(log n)", "O(n)", "O(n log n)", "O(n^2)"},
            {"DFS", "BFS", "Dijkstra's Algorithm", "Kruskal's Algorithm"},
            {"It can be resized", "It allows for efficient circular access", "It requires more memory than a linear queue", "It uses a priority ordering"},
            {"DFS", "BFS", "Bellman-Ford", "Union-Find"},
            {"A queue that processes elements based on their priority", "A queue where elements are processed in FIFO order", "A stack-like structure with priorities", "A sorted array"},
            {"O(n)", "O(n log n)", "O(1)", "O(n^2)"},
            {"Queue", "Stack", "Linked List", "Array"},
            {"When two keys hash to the same index", "When an element is not found", "When the hash table is full", "When the hash function fails"},
            {"O(n log n)", "O(n^2)", "O(n)", "O(log n)"},
            {"Array", "Linked List", "Hash Table", "Binary Tree"},
            {"To store data efficiently", "To find a key in constant time", "To resolve collisions", "To map a key to an index"},
            {"n-1", "n-2", "n", "2n-1"},
            {"Dijkstra's Algorithm", "Kosaraju's Algorithm", "Floyd-Warshall Algorithm", "Prim's Algorithm"},
            {"Divide the problem into sub-problems", "Reuse solutions to sub-problems", "Greedily select the next best step", "Use recursion without memoization"},
            {"Prim's Algorithm", "Kruskal's Algorithm", "0-1 Knapsack", "Dijkstra's Algorithm"},
            {"Array", "Hash Table", "Stack", "Dynamic Programming Table"},
            {"Faster access time", "Ability to traverse backwards", "Requires less memory", "Simpler to implement"},
            {"O(log n)", "O(n)", "O(n^2)", "O(n log n)"},
            {"O(log n)", "O(n)", "O(n log n)", "O(1)"},
            {"Inorder", "Preorder", "Postorder", "Level-order"},
            {"A matrix with more zero elements than non-zero elements", "A matrix with all non-zero elements", "A dense matrix", "None of the above"},
            {"Prim's uses a greedy approach; Kruskal's is more efficient", "Prim's starts from a vertex; Kruskal's sorts edges", "Both are the same", "Prim's works on directed graphs; Kruskal's on undirected graphs"},
            {"For searching text", "For approximate membership checking", "For sorting data", "For finding the shortest path"},
    ...
    public static void insertScoreIntoTable_Lo_1Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            String sql = "INSERT INTO student_result_dsa_level3_lo1 (Roll_number,lo1_score, exam_name, level) VALUES (?, ?, ?, ?);";
    ...
    public static void insertScoreIntoTable_Lo_2Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dsa_level3_lo2 (Roll_number,lo2_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dsa");
    ...
    public static void insertScoreIntoTable_Lo_3Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dsa_level3_lo3 (Roll_number,lo3_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dsa");
    ...
    public static void insertScoreIntoTable_Lo_4Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dsa_level3_lo4 (Roll_number,lo4_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dsa");
    ...
    public static void insertScoreIntoTable_Lo_5Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dsa_level3_lo5 (Roll_number,lo5_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dsa");
    ...
    public static void insertScoreIntoTable_Lo_6Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dsa_level3_lo6 (Roll_number,lo6_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dsa");
    ...
    public static void insertScoreIntoTable(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dsa_level3 (Roll_number,score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dsa");
