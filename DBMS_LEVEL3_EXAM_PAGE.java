...
public class DBMS_LEVEL3_EXAM_PAGE {
    ...
    public static void insertScoreIntoTable(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            String sql = "INSERT INTO student_result_dbms_level3 (Roll_number,score, exam_name, level) VALUES (?, ?, ?, ?);";
    ...
    public static void insertScoreIntoTable_Lo_1Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dbms_level3_lo1 (Roll_number,lo1_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dbms");
    ...
    public static void insertScoreIntoTable_Lo_2Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dbms_level3_lo2 (Roll_number,lo2_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dbms");
    ...
    public static void insertScoreIntoTable_Lo_3Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dbms_level3_lo3 (Roll_number,lo3_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dbms");
    ...
    public static void insertScoreIntoTable_Lo_4Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dbms_level3_lo4 (Roll_number,lo4_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dbms");
    ...
    public static void insertScoreIntoTable_Lo_5Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dbms_level3_lo5 (Roll_number,lo5_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dbms");
    ...
    public static void insertScoreIntoTable_Lo_6Scores(int score) throws SQLException {
        ...
        if (rollNumber != null) {
            ...
            // Prepare SQL statement
            String sql = "INSERT INTO student_result_dbms_level3_lo6 (Roll_number,lo6_score, exam_name, level) VALUES (?, ?, ?, ?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, rollNumber);
            preparedStatement.setInt(2, score);
            preparedStatement.setString(3, "dbms");
